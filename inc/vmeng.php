...
{
    $text = '感谢使用<a target="_blank" href="https://github.com/AkinoMaple/vmeng" >Vmeng主题 ' . Vmeng_Ver . '</a>进行创作';
    return $text;
}
...
{return get_bloginfo('template_directory') . '/lib/OwO' . $img;}
