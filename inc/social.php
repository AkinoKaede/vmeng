<div class="rewards-thumbups">
    ...
    <?php if( vm_get_option('thumbups_s') ){ ?> 
        <a href="javascript:;" data-action="thumbup" data-id="<?php the_ID(); ?>" class="thumbups-btn favorite<?php if(isset($_COOKIE['like_cookie'.$post->ID])) echo 'done';?>"><i class="fa fa-heart-o" aria-hidden="true"></i> <?php echo vm_get_option('thumbups_text', '喜欢') ?> <span class="count">(
