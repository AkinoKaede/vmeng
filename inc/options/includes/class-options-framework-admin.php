...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Vmeng 主题选项', 'options-framework'),
			'menu_title' => __('Vmeng 主题选项', 'options-framework'),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( '保存选项', 'options-framework' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重置选项', 'options-framework' ); ?>" onclick="return confirm( '<?php print esc_js( __( '点击OK重置，所有主题设置将丢失！', 'options-framework' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '默认选项已恢复。', 'options-framework' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( '选项已保存。', 'options-framework' ), 'updated fade' );
	}
