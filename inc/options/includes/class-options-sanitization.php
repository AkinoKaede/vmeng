...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( '不重复', 'options-framework' ),
		'repeat-x'  => __( '垂直重复', 'options-framework' ),
		'repeat-y'  => __( '水平重复', 'options-framework' ),
		'repeat'    => __( '全部重复', 'options-framework' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( '上左', 'options-framework' ),
		'top center'    => __( '上中', 'options-framework' ),
		'top right'     => __( 'T上右', 'options-framework' ),
		'center left'   => __( '中左', 'options-framework' ),
		'center center' => __( '中中', 'options-framework' ),
		'center right'  => __( '中右', 'options-framework' ),
		'bottom left'   => __( '下左', 'options-framework' ),
		'bottom center' => __( '下中', 'options-framework' ),
		'bottom right'  => __( '下右', 'options-framework')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( '普通滚动', 'options-framework' ),
		'fixed'  => __( '固定位置', 'options-framework')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( '普通', 'options-framework' ),
		'italic'      => __( '斜体', 'options-framework' ),
		'bold'        => __( '加粗', 'options-framework' ),
		'bold italic' => __( '加粗斜体', 'options-framework' )
		);
